...
declare module '$env/static/private' {
	...
	export const npm_config_strict_ssl: string;
	export const PENDO_STORAGE: string;
	export const npm_config_version_git_message: string;
	export const gvm_go_name: string;
	export const npm_config___pendo_jfrog_io_artifactory_api_npm_web__email: string;
	export const LOGNAME: string;
	export const npm_package_scripts_format: string;
	export const npm_package_peerDependencies_vite: string;
	...
	export const npm_lifecycle_script: string;
	export const npm_package_peerDependencies_svelte: string;
	export const PENDO_SESS_JWT: string;
	export const npm_config_ignore_path: string;
	export const npm_package_devDependencies__types_set_cookie_parser: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config_strict_ssl: string;
		PENDO_STORAGE: string;
		npm_config_version_git_message: string;
		gvm_go_name: string;
		npm_config___pendo_jfrog_io_artifactory_api_npm_web__email: string;
		LOGNAME: string;
		npm_package_scripts_format: string;
		npm_package_peerDependencies_vite: string;
		PREFIX: string;
